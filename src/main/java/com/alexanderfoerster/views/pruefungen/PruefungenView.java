...
import com.alexanderfoerster.data.SampleBook;
import com.alexanderfoerster.services.SampleBookService;
...
@PageTitle("Pruefungen")
@Route(value = "pruefungen/:sampleBookID?/:action?(edit)", layout = MainLayout.class)
@RolesAllowed("USER")
public class PruefungenView extends Div implements BeforeEnterObserver {

    private final String SAMPLEBOOK_ID = "sampleBookID";
    private final String SAMPLEBOOK_EDIT_ROUTE_TEMPLATE = "pruefungen/%s/edit";
    ...
    public PruefungenView(SampleBookService sampleBookService) {
        this.sampleBookService = sampleBookService;
        addClassNames("pruefungen-view");
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (sampleBookId.isPresent()) {
            ...
            if (sampleBookFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(PruefungenView.class);
            }
        }
    }
