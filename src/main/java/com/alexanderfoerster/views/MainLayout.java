package com.alexanderfoerster.views;

import com.alexanderfoerster.data.User;
import com.alexanderfoerster.security.AuthenticatedUser;
import com.alexanderfoerster.views.about.AboutView;
...
public class MainLayout extends AppLayout {
    ...
    private Component createHeaderContent() {
        ...
        H1 appName = new H1("Prüfungsmanager");
    ...
    private MenuItemInfo[] createMenuItems() {
        return new MenuItemInfo[]{ //
                ...
                new MenuItemInfo("Benutzer", LineAwesomeIcon.COLUMNS_SOLID.create(), BenutzerView.class), //
